...
//    DELETE  /forums/:forum       ->  destroy
    ...
    app.get('/blog/following/search/:blogSearch', [auth.requiresLogin] , blog.indexFollowing);
    ...
    app.get('/blog/mine/search/:blogSearch', [auth.requiresLogin] ,blog.indexMine);
